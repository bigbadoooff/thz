...
ENTITY_TRANSLATION_KEYS = {
    ...
    "p99CoolingHC1AreaFan": "cooling_hc1_distribution",
    ...
    # Note: "programHC1_Mo_0"-style day-program entries (HC1/HC2/DHW/Fan x
    # 30 day/slot combinations each = 120 entries) are NOT listed here.
    # Their translation key is always exactly the lowercased name with "-"
    # replaced by "_" (e.g. "programHC1_Mo-Fr_0" -> "programhc1_mo_fr_0"),
    # so get_translation_key() computes it below instead of duplicating it.
}
...
def get_translation_key(entity_name: str) -> str | None:
    ...
    """
    if entity_name.startswith("program"):
