"""More tests for the THZ config flow.

Covers the async_step_* methods of THZConfigFlow that are not already
exercised by setup/test_config_flow_ports.py:
...
# Link serial mock attribute chain (see setup/test_config_flow_ports.py for why).
